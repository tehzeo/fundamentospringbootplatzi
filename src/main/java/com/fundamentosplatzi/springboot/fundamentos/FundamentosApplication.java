...
public class FundamentosApplication implements CommandLineRunner {
	...
	Log LOGGER = LogFactory.getLog(com.fundamentosplatzi.springboot.fundamentos.controller.FundamentosApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication.run(com.fundamentosplatzi.springboot.fundamentos.controller.FundamentosApplication.class, args);
	}
	...
	private void getInformationJpsqlFromUser(){
		LOGGER.info("user with findByUserEmail" +  userRepository.findByUserEmail("teh.zeo@mail.com")
